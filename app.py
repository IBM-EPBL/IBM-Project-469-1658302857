...
client = Cloudant.iam('89a3abc1-41af-4522-95b8-3663025fe6cd-bluemix',
                        'TToxPFwqG1SjqtX53rkZzOnsqRpoZPRb9VkqGdkEnzXy', connect=True)
...
def predict():
    if request.method == "POST":
        ...
        index = ['Left_Bundle_Branch_Block','Normal','Premature atrial contraction','Ventricular Fibrillations','Premature ventricular Contractions','Right Bundle Brach Block']
        result = str(index[prediction[0]])
        print(result)
        account_sid = 'ACfa41da717c7b394e9003eb17e367eaed'
        auth_token = '0f2cf267bbf74ccbee1517ba7817551c'
